	...
	{			
		...
		if (hasNewFFTData)
		{
			...
			for (y=0; y<maxY; y++)
			{
                ...
                if ((double)interpVal > xxx)
                {
                    xxx = (double)interpVal;
                    xx = y;
                }
                if ((double)interpVal < yyy)
                {
                    yyy = (double)interpVal;
                    yy = y;
                }
                if (interpVal > 0){
                    NSString *aa;
                aa = [NSString stringWithFormat:@"fft %d %d\n", y, interpVal];
                     // NSLog(aa);
                }
#ifdef hack1
                if (y == 64) {
                    NSString *cc;
                    cc = [NSString stringWithFormat:@"fft %d %f\n", y, interpVal];
                    NSLog(cc);

                }
#endif
                if (y == 64 && interpVal >= 0.4) {
                    NSLog(@"beep");
                }
            ...
            bb = [NSString stringWithFormat:@"fft max %d %f\n", xx, xxx    ];
     // NSLog(bb);
            bb = [NSString stringWithFormat:@"fft min %d %f\n", yy, yyy    ];
           // NSLog(bb);
